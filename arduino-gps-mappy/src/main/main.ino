...
const char* microCodeSetTree[23][9] = {
    ...
    { "GO_TO__ IO_CONNECT/IO_SEND _CNCTMSG;", "GO_TO__ IO_LOG/IO_SEND RQST_IO_LOG;", "NOTHING;", "GO_TO__ MAIN_MENU;", "IO", "Conct", "Log", "_", "<" },               //IO Menu 2
    ...
    { "GO_TO__ GPS_NEW/IO_SEND _GPS_NEW;", "NOTHING;", "NOTHING;", "GO_TO__ GPS_MENU;", "Mapping", "New", "_", "_", "<" },  //GPS Start 5
    ...
    { "EXEC___ GET_GPS;", "IO_SEND _GPS_END/GO_TO__ GPS_START;", "IO_SEND _GPS_CANCL/GO_TO__ GPS_START;", "NOTHING;", "Polygon", "Mark", "End", "Cancel", "_" },  //GPS Start 21
